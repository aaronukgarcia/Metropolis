...
const codeJson = {
  "$comment": "GENERATED by tools/plan/generate.js from docs/planning/master-plan-v2.1.json — do not hand-edit (GR#3, GR#6). Regenerate after any master-plan change; GUIDs are stable across regenerations. Item STATUS is deliberately absent: the BOW is the only status source (node claude-bow.js show <mkey>).",

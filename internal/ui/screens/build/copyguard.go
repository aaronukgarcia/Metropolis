...
// before it does anything else. Registered in this package's own V200-V299
...
const ErrScreenCopied = "MET-V202"
...
// checkNotCopied, proj.Screen.checkNotCopied, and trade.Screen.
// checkNotCopied — same mechanism, same ordering rationale, restated here
// because each guarded type owns its own check.
//

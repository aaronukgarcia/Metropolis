...
| `sourcePack` | string | no (default `""`) | One of the six non-cosmetic §23 expansion-content-equivalent groups: `waterfront`, `shoreline`, `high-rise`, `retail`, `rail`, `office` (AC-9). The Cosmetic has no tag — §23 states it is cosmetic-only and skipped. |

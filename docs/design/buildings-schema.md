...
| `sourcePack` | string | no (default `""`) | One of the six non-cosmetic §23 expansion-content-equivalent groups: `waterfront-transport`, `coastal-shoreline`, `high-rise`, `high-street-retail`, `rail-stations`, `office-tiers` (AC-9). The regional cosmetic set has no tag — §23 states it is cosmetic-only and skipped. |

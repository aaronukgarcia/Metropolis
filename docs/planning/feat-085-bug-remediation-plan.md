...
- **Residuals folded (close free):** ASM-155, ASM-568, ASM-571, ASM-567, ASM-570, ASM-569, ASM-306.
...
- **Residuals folded (the shared `scanGitInvocations`/`resolveAliasDetailed` primitive Bob already Destructive-ACCEPTED dissolves):** ASM-360 (divergent GIT_TOKEN_RE — closed by construction), ASM-348/359/225/224 (KNOWN_COMMIT_VERBS), ASM-230/188 (`-C`/`-c` reuse-author), ASM-228, ASM-229/357/350/344/345/349/351/368/424/227/425/430/431/436/078/355/226/336/420/340/341/193/187/185/186/366/367.
...
- **Residuals folded (all symptoms of the 3-digit exhaustion):** ASM-527, ASM-534, ASM-543, ASM-547, ASM-073.
...
- **Why fourth:** root-cause-before-symptom (rule a) — stops the V/E950/G/H/J/K range-fight negotiation permanently and dissolves four U/E-layer contention ASMs at once. It no longer blocks MOD-031 (BUG-233 already unblocked it), so it ranks below the live game and guard work.
...
- **Residuals folded:** ASM-557, ASM-444/445/451/454/472/473, ASM-199, ASM-462/463, ASM-477, ASM-506, ASM-499, ASM-281.
...
- **Also folded in:** 2 `SEC-*` real bugs (SEC-055, SEC-060) and ~45 `ASM-*` residuals, closed free with their parents.
